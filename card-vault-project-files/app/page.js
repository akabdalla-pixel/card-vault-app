              ...
              <div style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', gap:10, marginBottom:14 }}>
                {[
                  ...
                  <div key={i} style={{ background:'#111', border:'1px solid #1a1a1a', borderRadius:10, padding:'12px 14px', position:'relative', overflow:'hidden' }}>
                    ...
                    <div style={{ fontFamily:"'JetBrains Mono',monospace", fontSize:18, fontWeight:900, color:s.color }}>{s.value}</div>
                  </div>
                ))}
              </div>
              {/* Mock card list */}
                ...
                {[
                  ...
                  <div key={i} style={{ display:'flex', alignItems:'center', justifyContent:'space-between', padding:'10px 14px', borderBottom: i<2?'1px solid #141414':'none' }}>
                    ...
                    <div style={{ textAlign:'right' }}>
                      <div style={{ fontFamily:"'JetBrains Mono',monospace", fontSize:13, fontWeight:800, color:'#fff' }}>{c.val}</div>
                      <div style={{ fontFamily:"'JetBrains Mono',monospace", fontSize:11, fontWeight:700, color:c.pos?'#22c55e':'#ef4444' }}>{c.gl}</div>
                    </div>
                  </div>
                ))}
              </div>
