      ...
      <div style={{ minHeight:'100vh', background:'#0a0a0a', display:'flex', alignItems:'center', justifyContent:'center', padding:20 }}>
        ...
        <div style={{ position:'relative', zIndex:1, width:'100%', maxWidth:380, animation:'fadeUp 0.4s ease' }}>
          ...
          <div style={{ background:'#111', border:'1px solid #1e1e1e', borderRadius:20, padding:32 }}>
            ...
            <h2 style={{ fontFamily:'var(--font-geist-sans)', fontSize:22, fontWeight:900, color:'#f0f0f0', letterSpacing:'-0.5px', margin:'0 0 20px', textAlign:'center' }}>Create account</h2>

            {error && (
              <div style={{ marginBottom:16, padding:'10px 14px', borderRadius:10, background:'rgba(248,113,113,0.08)', color:'#f87171', fontSize:13, border:'1px solid rgba(248,113,113,0.2)', fontFamily:'var(--font-geist-sans)' }}>
                {error}
              </div>
            )}
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
              <div>
                <label style={{ display:'block', fontSize:10, fontWeight:700, color:'#555', textTransform:'uppercase', letterSpacing:'0.08em', marginBottom:6, fontFamily:'var(--font-geist-sans)' }}>Name</label>
              ...
              <div>
                <label style={{ display:'block', fontSize:10, fontWeight:700, color:'#555', textTransform:'uppercase', letterSpacing:'0.08em', marginBottom:6, fontFamily:'var(--font-geist-sans)' }}>Email</label>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:12 }}>
                ...
                <div>
                  <label style={{ display:'block', fontSize:10, fontWeight:700, color:'#555', textTransform:'uppercase', letterSpacing:'0.08em', marginBottom:6, fontFamily:'var(--font-geist-sans)' }}>Confirm</label>
