    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 20, background: '#0a0a0a', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ width: '100%', maxWidth: 400, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div style={{ width: '100%', background: '#111', border: '1px solid #2a2a2a', borderRadius: 16, padding: '28px 28px 24px' }}>
          <h2 style={{ fontFamily: "'Outfit',sans-serif", fontSize: 18, fontWeight: 700, color: '#f0f0f0', margin: '0 0 20px', textAlign: 'center' }}>Sign In</h2>
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: 14 }}>
              ...
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} required style={{ width: '100%', padding: '11px 14px', borderRadius: 10, background: '#1a1a1a', border: '1px solid #2a2a2a', color: '#f0f0f0', fontSize: 14, outline: 'none', fontFamily: "'Outfit',sans-serif", boxSizing: 'border-box', transition: 'border-color 0.15s' }} placeholder="you@email.com"
            ...
            <div style={{ marginBottom: 22 }}>
              ...
              <input type="password" value={password} onChange={e => setPassword(e.target.value)} required style={{ width: '100%', padding: '11px 14px', borderRadius: 10, background: '#1a1a1a', border: '1px solid #2a2a2a', color: '#f0f0f0', fontSize: 14, outline: 'none', fontFamily: "'Outfit',sans-serif", boxSizing: 'border-box', transition: 'border-color 0.15s' }} placeholder="Your password"
                onFocus={e => e.target.style.borderColor = '#e53935'}
                onBlur={e => e.target.style.borderColor = '#2a2a2a'}
              />
            </div>
        ...
        <p style={{ textAlign: 'center', marginTop: 18, fontSize: 13, color: '#555', fontFamily: "'Outfit',sans-serif" }}>
          No account? <Link href="/signup" style={{ color: '#e53935', fontWeight: 600, textDecoration: 'none' }}>Sign Up</Link>
        </p>
      </div>
    </div>
  )
